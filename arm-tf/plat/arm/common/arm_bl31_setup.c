...
{
        //cypbest
        // create address mappings for all dram space
	mmap_add_region(ARM_DRAM1_BASE, ARM_DRAM1_BASE, ARM_DRAM1_SIZE, MT_MEMORY | MT_RW | MT_SECURE);
	mmap_add_region(ARM_DRAM2_BASE, ARM_DRAM2_BASE, ARM_DRAM2_SIZE, MT_MEMORY | MT_RW | MT_SECURE);
