...
ADBG_CASE_DEFINE(notworking, 9001, xtest_tee_test_9001,
	"Sanity Test Corrupt Meta Encrypted Key");
ADBG_CASE_DEFINE(notworking, 9002, xtest_tee_test_9002,
	"Sanity Test Corrupt Meta IV");
ADBG_CASE_DEFINE(notworking, 9003, xtest_tee_test_9003,
	"Sanity Test Corrupt Meta Tag");
ADBG_CASE_DEFINE(notworking, 9004, xtest_tee_test_9004,
	"Sanity Test Corrupt Meta Data");
ADBG_CASE_DEFINE(notworking, 9021, xtest_tee_test_9021,
	"Sanity Test Corrupt Meta File : first byte");
ADBG_CASE_DEFINE(notworking, 9022, xtest_tee_test_9022,
	"Sanity Test Corrupt Meta File : last byte");
ADBG_CASE_DEFINE(notworking, 9023, xtest_tee_test_9023,
	"Sanity Test Corrupt Meta File : random byte");
ADBG_CASE_DEFINE(notworking, 9501, xtest_tee_test_9501,
	"Sanity Test Corrupt Block IV");
ADBG_CASE_DEFINE(notworking, 9502, xtest_tee_test_9502,
	"Sanity Test Corrupt Block Tag");
ADBG_CASE_DEFINE(notworking, 9503, xtest_tee_test_9503,
	"Sanity Test Corrupt Block Data");
ADBG_CASE_DEFINE(notworking, 9521, xtest_tee_test_9521,
	"Sanity Test Corrupt Block File : first byte");
ADBG_CASE_DEFINE(notworking, 9522, xtest_tee_test_9522,
	"Sanity Test Corrupt Block File : last byte");
ADBG_CASE_DEFINE(notworking, 9523, xtest_tee_test_9523,
	"Sanity Test Corrupt Block File : random byte");
ADBG_CASE_DEFINE(notworking, 9524, xtest_tee_test_9524,
