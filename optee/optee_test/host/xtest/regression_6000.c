...
ADBG_CASE_DEFINE(notworking, 6001, xtest_tee_test_6001,
		 "Test TEE_CreatePersistentObject");
ADBG_CASE_DEFINE(notworking, 6002, xtest_tee_test_6002,
...
ADBG_CASE_DEFINE(notworking, 6005, xtest_tee_test_6005,
		 "Test TEE_SeekObjectData");
ADBG_CASE_DEFINE(notworking, 6006, xtest_tee_test_6006,
		 "Test TEE_CloseAndDeletePersistentObject");
ADBG_CASE_DEFINE(notworking, 6007, xtest_tee_test_6007,
		 "Test TEE_TruncateObjectData");
ADBG_CASE_DEFINE(regression, 6008, xtest_tee_test_6008,
		 "Test TEE_RenamePersistentObject");
ADBG_CASE_DEFINE(notworking, 6009, xtest_tee_test_6009,
	"Test TEE Internal API Persistent Object Enumeration Functions");
ADBG_CASE_DEFINE(notworking, 6010, xtest_tee_test_6010, "Test Storage");
...
ADBG_CASE_DEFINE(notworking, 6015, xtest_tee_test_6015, "Storage isolation");
ADBG_CASE_DEFINE(notworking, 6016, xtest_tee_test_6016, "Storage concurency");
ADBG_CASE_DEFINE(notworking, 6017, xtest_tee_test_6017,
		 "Test Persistent objects info");
ADBG_CASE_DEFINE(notworking, 6018, xtest_tee_test_6018, "Large object");
