...
#cp -r $OPTEE_HOME/optee/optee_os/out/arm-plat-zynqmp/export-ta_arm64/* ${TA_DEV_KIT_DIR}
...
make -j$(nproc) CROSS_COMPILE_HOST=aarch64-linux-gnu-
exit
...
cp libs/arm64-v8a/tee_helloworld $OPTEE_HOME/optee/hello_world/output/bin
